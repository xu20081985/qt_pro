...
public:
    ...
    void setupUi(QWidget *MyInputPanel)
    {
        ...
        panelButton_4 = new QPushButton(layoutWidget_1);
        ...
        panelButton_5 = new QPushButton(layoutWidget_1);
        ...
        panelButton_6 = new QPushButton(layoutWidget_1);
        ...
        panelButton_2 = new QPushButton(layoutWidget_1);
        ...
        panelButton_3 = new QPushButton(layoutWidget_1);
        ...
        panelButton_1 = new QPushButton(layoutWidget_1);
        ...
        panelButton_7 = new QPushButton(layoutWidget_1);
        ...
        panelButton_8 = new QPushButton(layoutWidget_1);
        ...
        panelButton_0 = new QPushButton(layoutWidget_1);
        ...
        closeBtn = new QPushButton(layoutWidget_1);
