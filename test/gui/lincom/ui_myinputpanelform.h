...
public:
    ...
    void setupUi(QWidget *MyInputPanel)
    {
        ...
        layoutWidget2 = new QWidget(MyInputPanel);
        layoutWidget2->setObjectName(QString::fromUtf8("layoutWidget2"));
        layoutWidget2->setGeometry(QRect(296, 0, 110, 161));
        verticalLayout = new QVBoxLayout(layoutWidget2);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        gridLayout = new QGridLayout();
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        panelButton_9 = new QPushButton(layoutWidget2);
        ...
        panelButton_4 = new QPushButton(layoutWidget2);
        ...
        panelButton_5 = new QPushButton(layoutWidget2);
        ...
        panelButton_6 = new QPushButton(layoutWidget2);
        ...
        panelButton_2 = new QPushButton(layoutWidget2);
        ...
        panelButton_3 = new QPushButton(layoutWidget2);
        ...
        panelButton_1 = new QPushButton(layoutWidget2);
        ...
        panelButton_7 = new QPushButton(layoutWidget2);
        ...
        panelButton_8 = new QPushButton(layoutWidget2);
        ...
        panelButton_0 = new QPushButton(layoutWidget2);
        ...
        closeBtn = new QPushButton(layoutWidget2);
